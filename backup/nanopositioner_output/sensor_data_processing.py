...
TURNING_POINT_METHOD = "first"  # Options: "first" or "algorithm"
# ============================================================================
...
def select_turning_point(df, first_idx, second_idx, first_type, method="algorithm"):
    """
...
keyence_turning_idx, keyence_turning_type = select_turning_point(
    ...
    keyence_first_extreme_type, method=TURNING_POINT_METHOD
)
...
arduino_turning_idx, arduino_turning_type = select_turning_point(
    ...
    arduino_first_extreme_type, method=TURNING_POINT_METHOD
)
...
df_arduino_after_extreme['displacement_mm'] = df_arduino_after_extreme['displacement_mm']
