#include <Arduino.h>
#include <timers.h>
#include "mag_encoder_bkwd_LUT_V88.h"
#include "mag_encoder_fwd_LUT_V88.h"
...
void display_position(){
  ...
  if (direction){
    axes[0].truePosition = axes[0].piezoPosition + mag_encoder_fwd_LUT_V88[abs(position_index-15)][axes[0].piezoPosition];
    
  } else{
    axes[0].truePosition = axes[0].piezoPosition + mag_encoder_bkwd_LUT_V88[abs(position_index-15)][axes[0].piezoPosition];
  }
